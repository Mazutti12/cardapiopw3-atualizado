  ...
  <br>
    ...
    <input type = "date" class = "calend"></input>
      ...
      <div class="buttons">
        ...
        <button type="button" onclick="window.location.href = './cadastro.php'"class="btn btn-danger">Cadastrar refeicao</button>
        <button type="button" onclick="window.location.href = './cadastroingre.php'" class="btn btn-danger">Cadastrar refeicao</button>
